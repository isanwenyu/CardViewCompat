...
package io.github.isanwenyu.cardview;
...
public class CardViewCompat extends FrameLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public boolean getUseCompatPadding() {
            return CardViewCompat.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return CardViewCompat.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            CardViewCompat.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                CardViewCompat.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                CardViewCompat.super.setMinimumHeight(height);
            }
        }
    ...
    public CardViewCompat(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public CardViewCompat(Context context, AttributeSet attrs, int defStyleAttr) {
